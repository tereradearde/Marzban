...
# Minutes after which an IP is no longer counted for ip_limit (subscription fetch).
SUB_IP_LIMIT_WINDOW_MINUTES = config("SUB_IP_LIMIT_WINDOW_MINUTES", cast=int, default=30)
